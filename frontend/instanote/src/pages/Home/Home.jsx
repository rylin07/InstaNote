...
const Home = () => {
  ...
  // Handle note creation from ChatGPT
  const handleCreateNote = (note) => {
    setOpenAddEditModal({
      isShown: true,
      type: "add",
      data: note, // Pre-filled note data
    });
    setShowChat(false); // Close ChatGPT after creating the note
  };
  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => setShowChat(true)} // Open ChatGPT
      >
      ...
      {showChat && (
        <ChatGPT
          ...
          onCreateNote={handleCreateNote} // Pass note creation handler
        />
      )}
